# <a href="https://1ce.org/1click-resize-to-half">1CE - 1Click Resize to half</a>

Reduce the browser window to half of the screen size. Useful when two windows should be placed next to each other.

Usage Guide:

1. Install the extension (click "Add to Chrome")
2. Click the extension icon (after installing it).
3. The window size will be reduced to half the size of your screen.
...
<a href="https://1ce.org/1click-resize-to-half">
<img src="https://1ce.org/screenshots/1click-resize-to-half-1.jpg" />
</a>
To view more screenshot please visit <a href="https://1ce.org">1CE - 1Click 1Click Resize to half</a> website.
...
The easiet way to install the plugin, is going to [1CE - 1Click Resize to half website](https://1ce.org/1click-resize-to-half), and then add it to chrome.
...
<a href="https://1ce.org/1click-resize-to-half/video">
